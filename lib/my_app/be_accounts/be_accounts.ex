defmodule MyApp.BeAccounts do
  ...
  def change_be_user_registration(%BeUser{} = be_user, attrs \\ %{}) do
    BeUser.registration_changeset(be_user, attrs, hash_password: false)
  end
  ...
  def change_be_user_email(be_user, attrs \\ %{}) do
    BeUser.email_changeset(be_user, attrs)
  end
  ...
  defp be_user_email_multi(be_user, email, context) do
    changeset = be_user |> BeUser.email_changeset(%{email: email}) |> BeUser.confirm_changeset()
  ...
  ## Examples
      ...
      iex> deliver_update_email_instructions(be_user, current_email, &Routes.be_user_update_email_url(conn, :edit, &1))
      {:ok, %{to: ..., body: ...}}

  """
  def deliver_update_email_instructions(%BeUser{} = be_user, current_email, update_email_url_fun)
  ...
  ## Examples
      ...
      iex> deliver_be_user_confirmation_instructions(be_user, &Routes.be_user_confirmation_url(conn, :confirm, &1))
      {:ok, %{to: ..., body: ...}}

      iex> deliver_be_user_confirmation_instructions(confirmed_be_user, &Routes.be_user_confirmation_url(conn, :confirm, &1))
  ...
  ## Examples
      ...
      iex> deliver_be_user_reset_password_instructions(be_user, &Routes.be_user_reset_password_url(conn, :edit, &1))
      {:ok, %{to: ..., body: ...}}
