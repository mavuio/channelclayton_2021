defmodule MyAppBe.BeEmail.MailLayoutHelpers do
  ...
  def mail_button(text, url, opts \\ [])
    ...
    <!--[if mso]>
      ...
      <![endif]-->
      <![if !mso]>
      <table cellspacing="0" cellpadding="0" align="<%= @align %>"> <tr>
      <td align="center" width="300" height="40" bgcolor="<%= @color %>" style="-webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; color: <%= @textcolor %>; display: block;">
