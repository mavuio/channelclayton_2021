defmodule MyAppBe.SeasonLive.SeasonEditComponent do
  @moduledoc false
  ...
  def update(assigns, socket) do
    rec =
      case assigns.rec_id do
        ...
        rec_id -> Seasons.get_season(MavuUtils.to_int(rec_id))
      end
  ...
  def get_changeset(%Season{} = model, params \\ %{}) do
    Season.changeset(model, params)
  end
